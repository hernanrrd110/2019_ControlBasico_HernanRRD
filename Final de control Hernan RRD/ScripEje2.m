...
%un PI,el sistema quedaría de tipo 2 y el error en estado estacionario 
%quedaria nulo
...
% Esto se debe a que el ajuste no será exacto, y es necesario corregir más
% fase
%Buscamos la fase donde es igual a -180 + MF y la ganancia en tal punto
w = 0.529
Mag_w = 10.7;
% La zona de diseño del PI empieza 10 decadas despues de la frecuancia de
